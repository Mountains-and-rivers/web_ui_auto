...
| **pip** | - | - | **26.1.2** | 随 Python 自带，建议最新版本 |
| **setuptools** | 45 | 85.0.0 | - | `>=45, <85.0.0` |
| **wheel** | 0.38.0 | 1.0.0 | - | `>=0.38.0, <1.0.0` |

### 🧪 测试框架
| 模块 | 最低版本 | 最高版本 | 当前版本 | 版本约束说明 |
|------|---------|---------|---------|-------------|
| **pytest** | 7.4.4 | 10.0.0 | - | `>=7.4.4, <10.0.0` |
| **pytest-playwright** | 0.4.3 | 1.0.0 | - | `>=0.4.3, <1.0.0` |
| **pytest-html** | 4.1.1 | 5.0.0 | - | `>=4.1.1, <5.0.0` |
| **allure-pytest** | 2.13.2 | 3.0.0 | - | `>=2.13.2, <3.0.0` |

### 🎭 浏览器自动化
| 模块 | 最低版本 | 最高版本 | 当前版本 | 版本约束说明 |
|------|---------|---------|---------|-------------|
| **playwright** | 1.40.0 | - | - | `>=1.40.0` (无上限) |

### ⚙️ 配置与日志
| 模块 | 最低版本 | 最高版本 | 当前版本 | 版本约束说明 |
|------|---------|---------|---------|-------------|
| **PyYAML** | 6.0.1 | 7.0.0 | - | `>=6.0.1, <7.0.0` |
| **loguru** | 0.7.2 | 1.0.0 | - | `>=0.7.2, <1.0.0` |

### 🎨 代码质量工具（开发依赖）
| 模块 | 最低版本 | 最高版本 | 当前版本 | 版本约束说明 |
|------|---------|---------|---------|-------------|
| **black** | 24.1.1 | 27.0.0 | - | `>=24.1.1, <27.0.0` |
| **flake8** | 7.0.0 | 8.0.0 | - | `>=7.0.0, <8.0.0` |
| **isort** | 5.13.2 | 9.0.0 | - | `>=5.13.2, <9.0.0` |
